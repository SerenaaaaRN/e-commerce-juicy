      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
          ...
          <div className="flex flex-col gap-6 md:col-span-6 z-10 text-left">
            ...
            <h1 className="font-['Space_Grotesk'] text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-wide text-foreground uppercase leading-[1.1] animate-in fade-in slide-in-from-left-4 duration-700">
              The Art of <br />
