...
- [x] saat ini user umum tanpa bukan role admin masih bisa crud dan masuk dashboard lewat url
...
- [x] Basic SEO: Image priority loading pada Product Detail
...
- [x] Toast notification (Success Add to Cart)
